...
class Contactus extends CI_Controller {
   ...
   function index()
   {
		...
		$this->table->add_row('QQ', '<a target="_blank" href="tencent://message/?uin=2079311233&site=qq&Menu=yes"><img border="0" src="'.base_url().'/image/qqtalk.png" alt="点击这里给我发消息" title="点击这里给我发消息"/></a>');
